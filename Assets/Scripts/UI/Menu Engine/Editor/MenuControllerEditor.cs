...
namespace MenuEngine.EditorScripts
{
    ...
    public class MenuControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (pages.arraySize > 0)
            {
                ...
                for(int i = 0; i < pages.arraySize;i++)
                {
                    ...
                    if (page.isExpanded)
                    {
                        ...
                        EditorGUILayout.PropertyField(page.FindPropertyRelative("FirstSelected"), new GUIContent("First Selected"));
            ...
            eventSystem.objectReferenceValue = EditorGUILayout.ObjectField("Event System", eventSystem.objectReferenceValue, typeof(UnityEngine.EventSystems.EventSystem), true);
